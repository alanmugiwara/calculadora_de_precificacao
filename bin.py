...
links_frame.grid(row=16, column=0, columnspan=2, pady=10, sticky='w')

# Adicione os links para as redes sociais com ícones
icon_alanamix = Image.open("C:\\site.png")  # Substitua "icon_alanamix.png" pelo caminho da imagem do ícone do AlanaMix
icon_alanamix = ImageTk.PhotoImage(icon_alanamix)
alanamix_link = tk.Label(links_frame, image=icon_alanamix)
alanamix_link.grid(row=0, column=0, padx=10, sticky='w')
alanamix_link.bind("<Button-1>", lambda e: open_url("https://www.alanamix.com.br"))

icon_instagram = Image.open("C:\\insta.png")  # Substitua "icon_instagram.png" pelo caminho da imagem do ícone do Instagram
icon_instagram = ImageTk.PhotoImage(icon_instagram)
instagram_link = tk.Label(links_frame, image=icon_instagram)
instagram_link.grid(row=0, column=1, padx=10, sticky='w')
instagram_link.bind("<Button-1>", lambda e: open_url("https://www.instagram.com/alanamixstore"))

icon_tiktok = Image.open("C:\\tiktok.png")  # Substitua "icon_tiktok.png" pelo caminho da imagem do ícone do TikTok
icon_tiktok = ImageTk.PhotoImage(icon_tiktok)
tiktok_link = tk.Label(links_frame, image=icon_tiktok)
tiktok_link.grid(row=0, column=2, padx=10, sticky='w')
tiktok_link.bind("<Button-1>", lambda e: open_url("https://www.tiktok.com/@alanamixstore"))
